...
\IfFileExists{../analysis_artifacts/fig1_routing_network.png}{\includegraphics[width=\textwidth,height=0.66\textheight,keepaspectratio]{../analysis_artifacts/fig1_routing_network.png}}{%
\IfFileExists{../analysis_artifacts/graph1_routing.png}{\includegraphics[width=\textwidth,height=0.66\textheight,keepaspectratio]{../analysis_artifacts/graph1_routing.png}}{%
...
\IfFileExists{../analysis_artifacts/fig2_trial_bias.png}{\includegraphics[width=\textwidth,height=0.66\textheight,keepaspectratio]{../analysis_artifacts/fig2_trial_bias.png}}{%
\IfFileExists{../analysis_artifacts/graph2_trial_bias.png}{\includegraphics[width=\textwidth,height=0.66\textheight,keepaspectratio]{../analysis_artifacts/graph2_trial_bias.png}}{%
...
\IfFileExists{../analysis_artifacts/fig3_confusion_matrices.png}{\includegraphics[width=\textwidth,height=0.66\textheight,keepaspectratio]{../analysis_artifacts/fig3_confusion_matrices.png}}{%
...
\begin{tikzpicture}[
  ...
  box/.style={draw, rounded corners, align=center, minimum width=2.4cm, minimum height=0.88cm, fill=softgray},
  risk/.style={draw, rounded corners, align=center, minimum width=2.4cm, minimum height=0.88cm, fill=softred!18},
  good/.style={draw, rounded corners, align=center, minimum width=2.4cm, minimum height=0.88cm, fill=softgreen!18},
  arr/.style={-{Stealth}, thick}
]
\node[box] (env) {Environment family\\clinical / quantum};
\node[risk, right=0.7cm of env] (ctx) {Observed context\\missing, noisy, delayed};
\node[box, right=0.7cm of ctx] (policy) {Policy family\\\mab / \cmab / \icmab};
\node[box, right=0.7cm of policy] (action) {Routing action\\test, triage, path};
\node[good, below=0.95cm of action] (outcome) {Observed outcome\\reward, latency, success};
\node[box, left=0.7cm of outcome] (fair) {Fairness state\\group, cohort, route};
\node[risk, left=0.7cm of fair] (report) {Reporting +\\validation hub};
\draw[arr] (env) -- node[above, font=\scriptsize]{1 generates 1..*} (ctx);
\draw[arr] (ctx) -- node[above, font=\scriptsize]{1 conditions 1} (policy);
\draw[arr] (policy) -- node[above, font=\scriptsize]{1 selects 1} (action);
\draw[arr] (action) -- node[right, font=\scriptsize]{1 yields 1} (outcome);
\draw[arr] (outcome) -- node[below, font=\scriptsize]{1 updates 1} (fair);
\draw[arr] (fair) -- node[below, font=\scriptsize]{1..* artifacts} (report);
\draw[arr, dashed] (report.west) to[bend right=35] node[below, font=\scriptsize]{feedback} (policy.south);
\end{tikzpicture}
\end{center}
