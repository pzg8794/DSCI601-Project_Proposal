...
\definecolor{TealAccent}{RGB}{34,139,154}
\definecolor{FairOrange}{RGB}{217,125,49}
\definecolor{ContextTeal}{RGB}{52,152,219}
\definecolor{SeqPurple}{RGB}{112,48,160}
\definecolor{ClinicalGreen}{RGB}{86,155,64}
\definecolor{SoftGray}{RGB}{92,92,92}
\definecolor{RiskRed}{RGB}{192,80,77}
\definecolor{PaleGray}{RGB}{246,248,251}
...
\setbeamercolor{block body}{fg=black,bg=PaleGray}
...
\begin{frame}
  ...
  \begin{columns}[T,onlytextwidth]
    \column{0.32\textwidth}
      \pillbox{FairOrange}{Fairness}{Track outcome gaps over time, not only average performance.}
    \column{0.32\textwidth}
      \pillbox{ContextTeal}{Context Quality}{Study missing, delayed, noisy, or unevenly available context.}
    \column{0.32\textwidth}
      \pillbox{SeqPurple}{Sequential Decisions}{Model workflows where each choice affects what comes next.}
  \end{columns}
\end{frame}
