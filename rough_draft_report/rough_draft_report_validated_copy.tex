...
\vspace{0.25em}
\caption{Clinical routing example for the shared problem. The left side shows
weak-context or baseline allocation and the right side shows context-aware
fairness allocation. The example visualizes the paper's core claim in the
clinical domain: scarce resources are routed under partial feedback, and
context quality shapes who absorbs the worst errors.}
