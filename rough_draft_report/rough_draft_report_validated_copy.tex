...
Appendix~\ref{app:algorithm_spectrum_trace} gives the code-level transition
from non-contextual bandits to contextual and predictive-context policies.
...
\begin{table}[t]
\caption{Policy aliases used in Algorithm~\ref{alg:equitas_bandit}.}
...
fairness audit across three policy families. What changes is the evidence
...
evidence. Unlike EQUITAS, which mediates fairness after utility scoring, iCMAB
acts as a context-side mediator before scoring.
...
\For{$t=1,\ldots,T$}
    ...
    and context-quality indicators $q_t$.
