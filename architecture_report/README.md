...
Files
- `architecture_report.tex` — submission-ready architecture writeup for Overleaf / LaTeX compilation.
...
Current status
1. `architecture_report.tex` is now the canonical architecture assignment writeup.
