# Draft 1 revision notes

This file records the major revisions applied to the `draft1` architecture
...
### 1. Added a stage-to-component master mapping table
Reason:
...
### 2. Tightened the stage descriptions
Reason:
...
### 3. Added the fairness--performance synthesis layer
Reason:
...
### 4. Revised the diagram spacing and routing
Reason:
...
### 5. Removed the conclusion section
Reason:
...
### 6. Kept the figure on its own landscape page
Reason:
...
### 7. Preserved the replication workflow
Reason:
