...
\draw[flow] (entry.east) -- (policy.west);
...
% Layer labels
\node[font=\Huge, text=phase1blue!80!black] at (27.0,15.0) {High-level CRISP-DM context};
\node[font=\Huge, text=phase2green!60!black] at (27.0,9.5) {Control Layer};
\node[font=\Huge, text=phase3orange!70!black] at (27.0,4.0) {Execution Layer};
\node[font=\Huge, text=phase4purple!75!black] at (27.0,-2.1) {Fairness--Performance Layer};
\node[font=\Huge, text=phase4purple!75!black] at (27.0,-7.0) {Artifacts Layer};
