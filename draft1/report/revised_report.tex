...
The cleanest way to present the current results is as a \emph{context-quality finding}. Across the inherited quantum corpora, richer context improves routing performance relative to no-context baselines. That is already scientifically useful because it identifies where the next fairness layer should attach: if context quality moves utility, then unequal context quality is a plausible mechanism for unequal service quality.
