...
\end{itemize}
Phase 1 establishes baseline performance and group disparities under controlled limited context and measurement noise, evaluates an initial mitigation mechanism, and produces an initial demo; Phase 2 tests robustness under distribution shift, runs ablations, and packages the framework for code review and final report/demo.
