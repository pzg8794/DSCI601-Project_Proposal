...
i) a simulation-first diagnostic-like sequential decision environment with controllable limited context and distribution shift,
...
\begin{itemize}
\item {\bf Build diagnostic testbed:} implement a sequential decision simulation (test/model choice, retesting, pipeline choice) with distribution shift and controllable limited context.
