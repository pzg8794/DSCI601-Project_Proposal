...
The goal is to implement and evaluate fairness aware and contextual MABs policies across two domains testbeds (diagnostic-like sequential decision simulation + quantum-routing simulator), and to report utility--fairness tradeoffs under shift. The work is structured to be feasible without sensitive clinical data access (simulation-first), while remaining extensible to approved open datasets. The tasks are:
\begin{itemize}
