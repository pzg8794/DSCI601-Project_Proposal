...
fairness/service-equity monitoring and mitigation can be computed and applied from the same run artifacts and per-layer state,
under identical experimental controls.
