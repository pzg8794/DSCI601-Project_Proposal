...
Here, ``diagnostic-like'' refers to sequential decision workflows such as test/model selection,
triage escalation, or pipeline selection under partial feedback and non-stationarity; it does
