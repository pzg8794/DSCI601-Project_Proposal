...
\title{Fair Contextual MABs for Equitable
Diagnostic Decision-Making Under Missing Context\\[0.3em]
...
multi-armed bandits (CMAB/iCMAB) to support sequential decision-making under uncertainty,
...
fairness-aware contextual MAB policies under controllable limited-context mechanisms and
