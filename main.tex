...
\noindent
The novelty is the {\bf integration}: evaluating fairness aware and contextual MABs policy choices in both domains, while reporting and mitigating fairness disparities {\bf over time} rather than only post-hoc.
