...
Two anchor papers provide the concrete testbeds used in this work: a clinical
...
important to monitor time-evolving disparities (e.g., FNR/FPR gaps)
(not only aggregate averages) and to apply
...
constraints. In clinical diagnostics, context may include patient features, test and
...
In this project, the two testbeds are grounded in prior work described in
\cite{garcia2025equitable_bioinformatics,garcia2026threat_aware_quantum_routing}.
...
\midrule
Primary project testbeds (two anchor papers)
...
\subsection{Primary project testbeds (two anchor papers)}
