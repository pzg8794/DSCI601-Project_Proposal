...
one domain remain effective and equitable when applied to the other.
...
\vspace{-0.45cm}
\caption{\tiny Modular framework for quantum routing evaluation, adapted from
\cite{garcia2026threat_aware_quantum_routing}. The evaluation stack separates allocator,
