...
and iii) a transfer study demonstrating the same policy stack in a quantum-routing simulator. The goal is to build a {\bf novel integration}: evaluating fairness aware and contextual MABs policy choices in both domains, while reporting and mitigating fairness disparities {\bf over time} rather than only post-hoc.
